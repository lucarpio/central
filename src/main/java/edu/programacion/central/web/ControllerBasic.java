...
public class ControllerBasic{
    ...
    public List<Post> getPosts(){
        ...
        post.add(new Post(1, "Desarrollo web para la enseñanza universitaria", "http://localhost:8080/img/carritoverde.jpg", new Date(), "Desarrollo web"));
        post.add(new Post(2, "Desarrollo web para la enseñanza universitaria", "http://localhost:8080/img/formulario.png", new Date(), "Desarrollo web Front End"));
        post.add(new Post(3, "Desarrollo web para la enseñanza universitaria", "http://localhost:8080/img/consulta.jpg", new Date(), "Desarrollo web Back End"));
